...
import { biuldNextAuthOptions } from '@/pages/api/auth/[...nextauth].api'
  ...
  return (
    <Container>
      ...
      <ProfileBox as="form" onSubmit={handleSubmit(handleUpdateProfile)}>
        ...
        <label>
          <Text size="sm">About your</Text>
          <TextArea {...register('bio')} />
          <FormAnnotation>
            Write a few sentences about yourself, your interests, your hobbies,
          </FormAnnotation>
        </label>
